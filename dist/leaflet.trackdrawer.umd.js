(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('leaflet'), require('@mapbox/corslite')) :
	typeof define === 'function' && define.amd ? define(['leaflet', '@mapbox/corslite'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.leaflet_trackdrawer_uncompressed = factory(global.L, global.corslite));
}(this, (function (L, corslite) { 'use strict';
	...
	var LayerContainer = L__default['default'].Evented.extend({
	  initialize: function initialize(parent) {
	    this._parent = parent;
	    var f = L__default['default'].featureGroup().addTo(parent).addEventParent(this);
	    this._elements = [f];
	    this.length = 1;
	  },
	  get: function get(i) {
	...
	var Edge = L__default['default'].Polyline.extend({
	  ...
	  initialize: function initialize(latlngs, options) {
	    L__default['default'].Polyline.prototype.initialize.call(this, latlngs, options);
	...
	function decodeLatLngs(latlngs) {
	  ...
	  for (var i = 0; i < size; i += 2) {
	    array.push(L__default['default'].latLng(latlngs[i], latlngs[i + 1]));
	  }
	...
	function decodeLatLng(latlng) {
	  return L__default['default'].latLng(latlng[0], latlng[1]);
	}

	var Track = L__default['default'].LayerGroup.extend({
	  options: {
	  ...
	  initialize: function initialize(options) {
	    ...
	    L__default['default'].LayerGroup.prototype.initialize.call(this);
	  ...
	  setOptions: function setOptions(options) {
	    ...
	    if (this.options.router !== undefined) {
	      this.options.routingCallback = function (previousMarker, marker, done) {
	        _this.options.router.route([L__default['default'].Routing.waypoint(previousMarker.getLatLng()), L__default['default'].Routing.waypoint(marker.getLatLng())], function (err, result) {
	  ...
	  getBounds: function getBounds() {
	    var bounds = L__default['default'].latLngBounds([]);
	  ...
	  getLatLngs: function getLatLngs() {
	    ...
	    var hasTrackStats = L__default['default'].TrackStats !== undefined;
	    var latlngs = [];
	    ...
	    this._nodesContainers.forEach(function () {
	      ...
	      do {
	        ...
	        nextEdge.getLatLngs().forEach(function (e) {
	          l.push(hasTrackStats ? L__default['default'].TrackStats.cache.getAll(e) : e);
	        });
	  ...
	  _stopoversToGeoJSON: function _stopoversToGeoJSON() {
	    ...
	    stopovers.forEach(function (node, idx) {
	      var e = hasTrackStats ? L__default['default'].TrackStats.cache.getAll(node.getLatLng()) : node.getLatLng();
	  ...
	  _edgesToFlatGeoJSON: function _edgesToFlatGeoJSON() {
	    ...
	    this._nodesContainers.forEach(function () {
	      do {
	        ...
	        nextEdge.getLatLngs().forEach(function (e) {
	          var e2 = hasTrackStats ? L__default['default'].TrackStats.cache.getAll(e) : e;
	  ...
	  refreshEdges: function refreshEdges(routingCallback) {
	    var _this7 = this;
	      ...
	      return regenerator.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              callback = routingCallback || _this7.options.routingCallback;

	              _this7._fireStart();

	              oldValue = _this7._fireEvents;
	              _this7._fireEvents = false;
	              promises = [];

	              _this7._nodesContainers.forEach(function (container) {
	            ...
	            case 8:
	              _this7._fireEvents = oldValue;

	              _this7._fireDone();

	              return _context.abrupt("return", _this7);
	  ...
	  _createNode: function _createNode(latlng) {
	    ...
	    return L__default['default'].TrackDrawer.node(latlng, {
	      metadata: metadata
	    });
	  },
	  restoreState: function restoreState(state, nodeCallback) {
	    var _this8 = this;
	      ...
	      return regenerator.wrap(function _callee2$(_context2) {
	        while (1) {
	          switch (_context2.prev = _context2.next) {
	            case 0:
	              callback = nodeCallback || _this8._createNode;

	              _this8._fireStart();

	              oldValue = _this8._fireEvents;
	              _this8._fireEvents = false;
	            ...
	            case 11:
	              ...
	              _this8._fireEvents = oldValue;

	              _this8._fireDone({
	                routes: routes
	              });

	              return _context2.abrupt("return", _this8);
	  ...
	  undo: function undo(nodeCallback) {
	    var _this9 = this;
	      ...
	      return regenerator.wrap(function _callee3$(_context3) {
	        while (1) {
	          switch (_context3.prev = _context3.next) {
	            case 0:
	              if (!(_this9.isUndoable() && _this9._computing === 0)) {
	                _context3.next = 7;
	                break;
	              }

	              _this9._currentStateIndex -= 1;
	              _this9._undoing = true;
	              _context3.next = 5;
	              return _this9.restoreState(_this9._states[_this9._currentStateIndex], nodeCallback);

	            case 5:
	              _this9._undoing = false;
	  ...
	  redo: function redo(nodeCallback) {
	    var _this10 = this;
	      ...
	      return regenerator.wrap(function _callee4$(_context4) {
	        while (1) {
	          switch (_context4.prev = _context4.next) {
	            case 0:
	              if (!(_this10.isRedoable() && _this10._computing === 0)) {
	                _context4.next = 7;
	                break;
	              }

	              _this10._currentStateIndex += 1;
	              _this10._undoing = true;
	              _context4.next = 5;
	              return _this10.restoreState(_this10._states[_this10._currentStateIndex], nodeCallback);

	            case 5:
	              _this10._undoing = false;
	  ...
	  addLayer: function addLayer(layer) {
	    if (layer instanceof L__default['default'].Marker) {
	      this.addNode(layer);
	    } else {
	      L__default['default'].LayerGroup.prototype.addLayer.call(this, layer);
	    }
	  },
	  _createEdge: function _createEdge(previousNode, node) {
	    ...
	    var edge = new Edge$1([previousNode.getLatLng(), node.getLatLng()], {
	    ...
	    if (this.options.debug) {
	      edge.on('tooltipopen', function () {
	        ...
	        edge.setTooltipContent("id: ".concat(_this11._getEdgeId(edge), " (on #").concat(_this11._getEdgeContainerIndex(edge), ")<br>") + "previous node: ".concat(startNodeId) + " (on #".concat(_this11._getNodeContainerIndex(_this11._getNode(startNodeId)), ")<br>") + "next node: ".concat(endNodeId) + " (on #".concat(_this11._getNodeContainerIndex(_this11._getNode(endNodeId)), ")"));
	      });
	      edge.bindTooltip('<>');
	    }
	  ...
	  _prepareNode: function _prepareNode(node, nodesContainer) {
	    ...
	    if (this.options.debug) {
	      node.on('tooltipopen', function () {
	        var _this12$_getPrevious = _this12._getPrevious(node),
	            previousEdge = _this12$_getPrevious.previousEdge,
	            previousNode = _this12$_getPrevious.previousNode;

	        var _this12$_getNext = _this12._getNext(node),
	            nextEdge = _this12$_getNext.nextEdge,
	            nextNode = _this12$_getNext.nextNode;

	        node.setTooltipContent("id: ".concat(_this12._getNodeId(node), " (on #").concat(_this12._getNodeContainerIndex(node), ")<br>") + "previous edge: ".concat(_this12._getEdgeId(previousEdge)) + " (on #".concat(_this12._getEdgeContainerIndex(previousEdge), ") to ").concat(_this12._getNodeId(previousNode), "<br>") + "next edge: ".concat(_this12._getEdgeId(nextEdge)) + " (on #".concat(_this12._getEdgeContainerIndex(nextEdge), ") to ").concat(_this12._getNodeId(nextNode)));
	      });
	      node.bindTooltip('<>');
	    }
	    ...
	    if (node.options.draggable) {
	      node.on('dragstart', function (e) {
	        return _this12._onDragStartNode(e.target);
	      });
	      node.on('drag', function (e) {
	        return _this12._onDragNode(e.target);
	      });
	      node.on('moveend', function (e) {
	        return _this12.onMoveNode(e.target);
	      });
	    }
	    ...
	    return new Promise(function (resolve, reject) {
	      callback.call(null, previousNode, node, function (err, route) {
	        ...
	        if (previousEdge._computation === currentComputation) {
	          ...
	          previousNode.setLatLng(L__default['default'].latLng(route[0]));
	          node.setLatLng(L__default['default'].latLng(route[route.length - 1]));
	    ...
	    var promise1 = new Promise(function (resolve, reject) {
	      callback.call(null, startMarker, node, function (err, route1) {
	        ...
	        if (edge1._computation === currentComputation1) {
	          startMarker.setLatLng(L__default['default'].latLng(route1[0]));
	          node.setLatLng(L__default['default'].latLng(route1[route1.length - 1]));
	    ...
	    var promise2 = new Promise(function (resolve, reject) {
	      callback.call(null, node, endMarker, function (err, route2) {
	        ...
	        if (edge2._computation === currentComputation2) {
	          node.setLatLng(L__default['default'].latLng(route2[0]));
	          endMarker.setLatLng(L__default['default'].latLng(route2[route2.length - 1]));
	    ...
	    if (previousEdge !== undefined) {
	      ...
	      promises.push(new Promise(function (resolve, reject) {
	        callback.call(null, previousNode, marker, function (err, route) {
	          ...
	          if (previousEdge._computation === currentComputation) {
	            marker.setLatLng(L__default['default'].latLng(route[route.length - 1]));
	            previousEdge.setLatLngs(route);
	            previousEdge.options.metadata = JSON.parse(JSON.stringify(metadata));
	            previousEdge.setStyle({
	              dashArray: null
	      ...
	      promises.push(new Promise(function (resolve, reject) {
	        callback.call(null, marker, nextNode, function (err, route) {
	          ...
	          if (nextEdge._computation === _currentComputation) {
	            marker.setLatLng(L__default['default'].latLng(route[0]));
	  ...
	  promoteNodeToStopover: function promoteNodeToStopover(node) {
	    ...
	    var newNodesContainer = L__default['default'].featureGroup();
	    var newEdgesContainer = L__default['default'].featureGroup();
	    ...
	    nodes.forEach(function (e) {
	      e.removeFrom(_this17._getNodeContainer(e)).addTo(newNodesContainer);
	    });
	    edges.forEach(function (e) {
	      e.removeFrom(_this17._getEdgeContainer(e)).addTo(newEdgesContainer);
	    });
	  ...
	  demoteNodeToWaypoint: function demoteNodeToWaypoint(node) {
	    ...
	    nodes.forEach(function (e) {
	      e.removeFrom(_this18._getNodeContainer(e)).addTo(previousNodesContainer);
	    });
	    edges.forEach(function (e) {
	      e.removeFrom(_this18._getEdgeContainer(e)).addTo(previousEdgesContainer);
	    });
	...
	var ToolBar = createCommonjsModule(function (module) {
	  if (L__default['default'].Control.EasyBar === undefined) {
	    module.exports = {
	      ToolBar: undefined,
	      toolBar: undefined
	    };
	  } else {
	    var _ToolBar = L__default['default'].Control.EasyBar.extend({
	      options: {
	        mode: null,
	      ...
	      initialize: function initialize(track, options) {
	        ...
	        L__default['default'].Control.EasyBar.prototype.initialize.call(this, this._initializeButtons(), options);
	        this.setMode(this.options.mode);

	        this._track.getStepsContainer().on('click', function (e) {
	          if (_this.options.mode === 'insert') {
	            var marker = L__default['default'].TrackDrawer.node(e.latlng);
	            var route = e.layer;
	            route.setStyle({
	              weight: 3
	            });
	      ...
	      _initializeButtons: function _initializeButtons() {
	        ...
	        var buttons = [];
	        this._addBtn = L__default['default'].easyButton({
	          id: 'trackdrawer-add',
	          states: [{
	            stateName: 'loaded',
	            icon: 'fa-plus',
	        ...
	        this._insertBtn = L__default['default'].easyButton({
	        ...
	        this._closeLoop = L__default['default'].easyButton({
	          ...
	          states: [{
	            ...
	            onClick: function onClick() {
	              if (_this2._track.hasNodes(2)) {
	                ...
	                var marker = L__default['default'].TrackDrawer.node(nodes[0].markers[0].getLatLng()).addTo(_this2._track);
	        ...
	        this._deleteBtn = L__default['default'].easyButton({
	        ...
	        this._promoteBtn = L__default['default'].easyButton({
	        ...
	        this._demoteBtn = L__default['default'].easyButton({
	        ...
	        this._cleanBtn = L__default['default'].easyButton({
	        ...
	        if (this._track.options.undoable) {
	          this._undoBtn = L__default['default'].easyButton({
	            id: 'trackdrawer-undo',
	            states: [{
	              icon: 'fa-undo',
	              ...
	              onClick: function onClick() {
	                _this2._track.undo(function (latlng) {
	                  var marker = L__default['default'].TrackDrawer.node(latlng);
	          ...
	          this._redoBtn = L__default['default'].easyButton({
	            id: 'trackdrawer-redo',
	            states: [{
	              icon: 'fa-repeat',
	      ...
	      onAdd: function onAdd(map) {
	        ...
	        this._onMapClickHandler = function (e) {
	          if (_this3.options.mode === 'add') {
	            var marker = L__default['default'].TrackDrawer.node(e.latlng).addTo(_this3._track);
	        ...
	        L__default['default'].DomEvent.on(map, 'click', this._onMapClickHandler);
	        return L__default['default'].Control.EasyBar.prototype.onAdd.call(this, map);
	      },
	      onRemove: function onRemove(map) {
	        var _this4 = this;

	        if (this.options.mode === 'add') map.getContainer().style.cursor = '';
	        L__default['default'].DomEvent.off(map, 'click', this._onMapClickHandler);
	    ...
	    module.exports = {
	      ...
	      toolBar: function toolBar(track, options) {
	        return new _ToolBar(track, options);
	      }
	    };
	  }
	});

	var TraceModeBar = createCommonjsModule(function (module) {
	  if (L__default['default'].Control.EasyBar === undefined) {
	    module.exports = {
	    ...
	    var _TraceModeBar = L__default['default'].Control.EasyBar.extend({
	      options: {
	        mode: null
	      },
	      initialize: function initialize(track, modes, options) {
	        this._track = track;
	        this._buttonsMap = {};
	        L__default['default'].Control.EasyBar.prototype.initialize.call(this, this._initializeButtons(modes), options);
	        this.setMode(this.options.mode);
	      },
	      setMode: function setMode(m) {
	        var _this = this;
	      ...
	      _initializeButtons: function _initializeButtons(modes) {
	        ...
	        modes.forEach(function (m) {
	          var btn = L__default['default'].easyButton({
	    ...
	    module.exports = {
	      TraceModeBar: _TraceModeBar,
	      traceModeBar: function traceModeBar(track, modes, options) {
	        return new _TraceModeBar(track, modes, options);
	      }
	    };
	  }
	});

	var Node = L__default['default'].Marker.extend({
	  ...
	  initialize: function initialize(latlng, options) {
	    L__default['default'].Marker.prototype.initialize.call(this, latlng, options);
	    L__default['default'].setOptions(this, options);
	  ...
	  setType: function setType(type) {
	    ...
	    if (type === 'stopover') {
	      this.setIcon(L__default['default'].AwesomeMarkers.icon({
	        icon: 'pause-circle',
	  ...
	  setStyle: function setStyle(style) {
	    L__default['default'].Util.setOptions(this, style);
	...
	function splitLatLngs(latlngs) {
	  ...
	  while (latlngs.length > 0) {
	    var latlng = L__default['default'].latLng(latlngs.splice(0, 1)[0]);
	    tmp.push(latlng);
	...
	var Track$1 = Track_1.Track;
	Track$1.include({
	  _createFileLoader: function _createFileLoader() {
	    this._fileLoader = L__default['default'].FileLayer.fileLoader(null, {
	      addToMap: false,
	  ...
	  createFileLoaderControl: function createFileLoaderControl() {
	    ...
	    this._fileLoaderController = L__default['default'].Control.fileLayerLoad({
	      addToMap: false,
	      fileSizeLimit: this.options.fileSizeLimit || 1024,
	      formats: this.options.fileFormat || ['.geojson', '.json', '.kml', '.gpx']
	    }).addTo(this._map);
	  ...
	  _dataLoadedHandler: function _dataLoadedHandler(layer) {
	    var _arguments = arguments,
	        _this2 = this;

	    return asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	      var insertWaypoints, oldValue, latlngs, lastMarker, hasToolbar, _loop, i;

	      return regenerator.wrap(function _callee$(_context3) {
	        while (1) {
	          switch (_context3.prev = _context3.next) {
	            case 0:
	              insertWaypoints = _arguments.length > 1 && _arguments[1] !== undefined ? _arguments[1] : false;

	              _this2._fireStart();

	              oldValue = _this2._fireEvents;
	              _this2._fireEvents = false;
	              ...
	              hasToolbar = _this2._toolbar !== undefined;
	                  ...
	                  while (1) {
	                    switch (_context2.prev = _context2.next) {
	                      case 0:
	                        ...
	                        _loop2 = /*#__PURE__*/regenerator.mark(function _loop2(j) {
	                          var l;
	                            ...
	                            while (1) {
	                              switch (_context.prev = _context.next) {
	                                case 0:
	                                  ...
	                                  lastMarker = L__default['default'].TrackDrawer.node(l[0]);
	                                  _context.next = 6;
	                                ...
	                                case 7:
	                                  lastMarker = L__default['default'].TrackDrawer.node(l[l.length - 1], {
	  ...
	  loadData: function loadData(data, name, ext) {
	    ...
	    return new Promise(function (resolve, reject) {
	      _this3._fileLoader.on('data:loaded', /*#__PURE__*/function () {
	        var _ref = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(event) {
	  ...
	  loadFile: function loadFile(file) {
	    ...
	    return new Promise(function (resolve, reject) {
	      _this4._fileLoader.on('data:loaded', /*#__PURE__*/function () {
	        var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(event) {
	  ...
	  loadUrl: function loadUrl(url) {
	    ...
	    return new Promise(function (resolve, reject) {
	      corslite__default['default'](proxiedUrl, function (err, resp) {
	        if (!err) {
	          try {
	            _this5._fileLoader.on('data:loaded', /*#__PURE__*/function () {
	              var _ref3 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(event) {
	...
	Track$1.addInitHook('_createFileLoader');

	var Track$2 = Track_1.Track,
	    track = Track_1.track;
	var ToolBar$1 = ToolBar.ToolBar,
	    toolBar = ToolBar.toolBar;
	var TraceModeBar$1 = TraceModeBar.TraceModeBar,
	    traceModeBar = TraceModeBar.traceModeBar;
	var Node$1 = Node_1.Node,
	    node = Node_1.node;
	var Edge$2 = Edge_1.Edge,
	    edge = Edge_1.edge;
	/** @module L.TrackDrawer */

	L__default['default'].TrackDrawer = {
	  Track: Track$2,
	  track: track,
	  ToolBar: ToolBar$1,
	  toolBar: toolBar,
	  TraceModeBar: TraceModeBar$1,
	...
	var src = L__default['default'].TrackDrawer;

	return src;

})));
//# sourceMappingURL=leaflet.trackdrawer.umd.js.map
